...
account_sid = 'AC96c92e65129ff01b15434206c6a1aef7'
auth_token = '43f751b3dc3250a486f5b163df8f1f9a'
client = Client(account_sid, auth_token)
twilio_num = '+18155678541'
target = '+918600263475'
...
def sendOTPOverMobile(target, otp):
    if(validateMobile(target)):
        ...
        message = client.messages.create(
            body = "Your OTP is " + otp + ". Valid for next 10 minutes.",
            from_= twilio_num,
            to=target
        )
...
if __name__ == "__main__":
    ...
    sender = "amazingpython10@gmail.com"
    password = "hefafurxshvtxvys"
